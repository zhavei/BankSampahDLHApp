package com.example.banksampahdlhapp
...
import com.example.banksampahdlhapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //chekInternetConnect()
        //region build version & permission
        ...
        webView.webViewClient = object : WebViewClient() {
            ...
            override fun onReceivedError(
                ...
                snackBarError()
                //layout error
                binding.layoutError.nointernet.visibility = View.VISIBLE
            }
        }
        ...
        if (!checkGpsEnabled()) {
            ...
            alertDialog.setTitle("Izinkan Lokasi")
            alertDialog.setMessage("Aktifkan GPS. Pergi ke settings menu?")
